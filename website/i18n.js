...
const pageCopy = {
	home: {
		...
		text: {
			...
			"桌面版 1.5.1 · Android 预览版 1.5.1": "Desktop 1.5.1 · Android preview 1.5.1",
			"移动预览版 · 1.5.1": "Mobile preview · 1.5.1",
			"手机与平板 · Android 8.0+": "Phones and tablets · Android 8.0+",
			"Android 8.0+ · 预览版 1.5.1": "Android 8.0+ · Preview 1.5.1",
			...
			"CubeOffice 1.5.1 · macOS、Windows 与 Linux":
				"CubeOffice 1.5.1 · macOS, Windows, and Linux",
			...
			"桌面版本 · 1.5.1": "Desktop release · 1.5.1",
			...
			"CubeOffice 1.5.1 桌面版和 Android 1.5.1 预览版现已开放下载。":
				"CubeOffice 1.5.1 desktop apps and the Android 1.5.1 preview are available now.",
			"macOS、Windows 与 Linux 桌面版现已开放下载。":
				"CubeOffice 1.5.1 is available for macOS, Windows, and Linux.",
		},
		attributes: {
			"CubeOffice 首页": "CubeOffice home",
	...
	templates: {
		...
		text: {
			...
			"CubeOffice 1.5.1": "CubeOffice 1.5.1",

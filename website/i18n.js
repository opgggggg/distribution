...
const pageCopy = {
	home: {
		...
		text: {
			...
			"桌面版 1.4.6 · Android 预览版 1.4.6": "Desktop 1.4.6 · Android preview 1.4.6",
			"移动预览版 · 1.4.6": "Mobile preview · 1.4.6",
			"手机与平板 · Android 8.0+": "Phones and tablets · Android 8.0+",
			"Android 8.0+ · 预览版 1.4.6": "Android 8.0+ · Preview 1.4.6",
			...
			"CubeOffice 1.4.6 · macOS、Windows 与 Linux":
				"CubeOffice 1.4.6 · macOS, Windows, and Linux",
			...
			"桌面版本 · 1.4.6": "Desktop release · 1.4.6",
			...
			"CubeOffice 1.4.6 桌面版和 Android 1.4.6 预览版现已开放下载。":
				"CubeOffice 1.4.6 desktop apps and the Android 1.4.6 preview are available now.",
			"macOS、Windows 与 Linux 桌面版现已开放下载。":
				"CubeOffice 1.4.6 is available for macOS, Windows, and Linux.",
		},
		attributes: {
			"CubeOffice 首页": "CubeOffice home",
	...
	templates: {
		...
		text: {
			...
			"CubeOffice 1.4.6": "CubeOffice 1.4.6",

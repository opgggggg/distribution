...
const pageCopy = {
	home: {
		...
		text: {
			...
			"CubeOffice 1.1.1 · macOS、Windows 与 Linux":
				"CubeOffice 1.1.1 · macOS, Windows, and Linux",
			"AI 已连接": "AI connected",
			文件: "File",
			插入: "Insert",
			布局: "Layout",
			...
			"桌面版本 · 1.1.1": "Desktop release · 1.1.1",
			...
			"macOS、Windows 与 Linux 桌面版现已开放下载。":
				"CubeOffice 1.1.1 is available for macOS, Windows, and Linux.",
		},
		attributes: {
			"CubeOffice 首页": "CubeOffice home",

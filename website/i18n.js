...
const pageCopy = {
	home: {
		...
		text: {
			...
			"桌面版 1.4.7 · Android 预览版 1.4.7": "Desktop 1.4.7 · Android preview 1.4.7",
			"移动预览版 · 1.4.7": "Mobile preview · 1.4.7",
			"手机与平板 · Android 8.0+": "Phones and tablets · Android 8.0+",
			"Android 8.0+ · 预览版 1.4.7": "Android 8.0+ · Preview 1.4.7",
			...
			"CubeOffice 1.4.7 · macOS、Windows 与 Linux":
				"CubeOffice 1.4.7 · macOS, Windows, and Linux",
			...
			"桌面版本 · 1.4.7": "Desktop release · 1.4.7",
			...
			"CubeOffice 1.4.7 桌面版和 Android 1.4.7 预览版现已开放下载。":
				"CubeOffice 1.4.7 desktop apps and the Android 1.4.7 preview are available now.",
			"macOS、Windows 与 Linux 桌面版现已开放下载。":
				"CubeOffice 1.4.7 is available for macOS, Windows, and Linux.",
		},
		attributes: {
			"CubeOffice 首页": "CubeOffice home",
	...
	templates: {
		...
		text: {
			...
			"CubeOffice 1.4.7": "CubeOffice 1.4.7",
